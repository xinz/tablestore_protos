...
defmodule ExAliyunOts.TableStoreTunnel.GetCheckpointRequest do
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_tunnel_id(msg) |> encode_client_id(msg) |> encode_channel_id(msg)
      end
    )
      ...
      defp encode_channel_id(acc, msg) do
        try do
          case msg.channel_id do
            ...
            _ -> [acc, "\x1A", Protox.Encode.encode_string(msg.channel_id)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          {msg, set_fields} =
            parse_key_value([], bytes, struct(ExAliyunOts.TableStoreTunnel.GetCheckpointRequest))

          case [:tunnel_id, :client_id, :channel_id] -- set_fields do
            [] -> msg
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        ExAliyunOts.TableStoreTunnel.GetCheckpointRequest,
  ...
  (
    @spec required_fields() :: [(:tunnel_id | :client_id) | :channel_id]
    def required_fields() do
      [:tunnel_id, :client_id, :channel_id]
    end
  )
