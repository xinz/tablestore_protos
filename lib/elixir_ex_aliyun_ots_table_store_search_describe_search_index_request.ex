...
defmodule ExAliyunOts.TableStoreSearch.DescribeSearchIndexRequest do
  @moduledoc false
  defstruct table_name: nil, index_name: nil
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_table_name(msg) |> encode_index_name(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(ExAliyunOts.TableStoreSearch.DescribeSearchIndexRequest))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        ExAliyunOts.TableStoreSearch.DescribeSearchIndexRequest,
  ...
  (
    ...
    def defs() do
      %{1 => {:table_name, {:scalar, ""}, :string}, 2 => {:index_name, {:scalar, ""}, :string}}
    end
    ...
    def defs_by_name() do
      %{index_name: {2, {:scalar, ""}, :string}, table_name: {1, {:scalar, ""}, :string}}
    end
  )
