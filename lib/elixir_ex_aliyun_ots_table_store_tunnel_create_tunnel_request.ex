...
defmodule(ExAliyunOts.TableStoreTunnel.CreateTunnelRequest) do
  ...
  (
          ...
          {new_set_fields, field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {1, _, bytes} ->
                ...
                value = ExAliyunOts.TableStoreTunnel.Tunnel.decode!(delimited)
    ...
    def(defs()) do
      %{1 => {:tunnel, {:default, nil}, {:message, ExAliyunOts.TableStoreTunnel.Tunnel}}}
    end
    ...
    def(defs_by_name()) do
      %{tunnel: {1, {:default, nil}, {:message, ExAliyunOts.TableStoreTunnel.Tunnel}}}
    end
