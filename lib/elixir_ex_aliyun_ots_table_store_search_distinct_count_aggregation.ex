...
defmodule ExAliyunOts.TableStoreSearch.DistinctCountAggregation do
    ...
    [
      ...
      defp encode_missing(acc, msg) do
        try do
          case msg.missing do
            nil -> acc
            _ -> [acc, "\x12", Protox.Encode.encode_bytes(msg.missing)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(ExAliyunOts.TableStoreSearch.DistinctCountAggregation))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        ExAliyunOts.TableStoreSearch.DistinctCountAggregation,
  ...
  (
    ...
    def defs() do
      %{1 => {:field_name, {:scalar, ""}, :string}, 2 => {:missing, {:scalar, ""}, :bytes}}
    end
    ...
    def defs_by_name() do
      %{field_name: {1, {:scalar, ""}, :string}, missing: {2, {:scalar, ""}, :bytes}}
    end
  )
