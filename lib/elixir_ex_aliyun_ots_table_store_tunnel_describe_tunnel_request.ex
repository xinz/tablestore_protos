      ...
      defp encode_tunnel_name(acc, msg) do
        try do
          case msg.tunnel_name do
            ...
            _ -> [acc, "\x12", Protox.Encode.encode_string(msg.tunnel_name)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_tunnel_id(acc, msg) do
        try do
          case msg.tunnel_id do
            nil -> acc
            _ -> [acc, "\x1A", Protox.Encode.encode_string(msg.tunnel_id)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          {msg, set_fields} =
            parse_key_value([], bytes, struct(ExAliyunOts.TableStoreTunnel.DescribeTunnelRequest))
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        ExAliyunOts.TableStoreTunnel.DescribeTunnelRequest,
