  ...
  (
    ...
    def(defs()) do
      %{
        ...
        7 => {:filter, {:default, ""}, :bytes},
        8 => {:start_column, {:default, ""}, :string},
        9 => {:end_column, {:default, ""}, :string},
        10 => {:token, {:default, ""}, :bytes},
        11 => {:transaction_id, {:default, ""}, :string}
      }
    end
