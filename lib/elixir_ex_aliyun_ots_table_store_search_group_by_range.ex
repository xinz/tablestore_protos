  ...
  (
    ...
    def(defs()) do
      %{
        ...
        3 => {:sub_aggs, {:default, nil}, {:message, ExAliyunOts.TableStoreSearch.Aggregations}},
        4 => {:sub_group_bys, {:default, nil}, {:message, ExAliyunOts.TableStoreSearch.GroupBys}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        sub_aggs: {3, {:default, nil}, {:message, ExAliyunOts.TableStoreSearch.Aggregations}},
        sub_group_bys: {4, {:default, nil}, {:message, ExAliyunOts.TableStoreSearch.GroupBys}}
      }
    end
