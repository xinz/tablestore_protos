...
defmodule ExAliyunOts.TableStoreTunnel.Token do
  ...
  (
    ...
    [
      defp encode_version(acc, msg) do
        try do
          case msg.version do
            nil -> raise Protox.RequiredFieldsError.new([:version])
            _ -> [acc, "\b", Protox.Encode.encode_int64(msg.version)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_content(acc, msg) do
        try do
          case msg.content do
            nil -> raise Protox.RequiredFieldsError.new([:content])
            _ -> [acc, "\x12", Protox.Encode.encode_bytes(msg.content)]
          end
        rescue
          ArgumentError ->
        ...
        {new_set_fields, field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              ...
              {[:content | set_fields], [content: delimited], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        ExAliyunOts.TableStoreTunnel.Token,
  ...
  (
    ...
    def defs() do
      %{1 => {:version, {:scalar, 0}, :int64}, 2 => {:content, {:scalar, ""}, :bytes}}
    end
    ...
    def defs_by_name() do
      %{content: {2, {:scalar, ""}, :bytes}, version: {1, {:scalar, 0}, :int64}}
    end
  )
