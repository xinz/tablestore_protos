...
defmodule ExAliyunOts.TableStore.GetStreamRecordRequest do
  @moduledoc false
  defstruct shard_iterator: nil, limit: nil, table_name: nil
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_shard_iterator(msg) |> encode_limit(msg) |> encode_table_name(msg)
      end
    )
      ...
      defp encode_shard_iterator(acc, msg) do
        try do
          case msg.shard_iterator do
            nil -> raise Protox.RequiredFieldsError.new([:shard_iterator])
            _ -> [acc, "\n", Protox.Encode.encode_string(msg.shard_iterator)]
          end
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:shard_iterator, "invalid field value"),
                    __STACKTRACE__
        end
      end,
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        ExAliyunOts.TableStore.GetStreamRecordRequest,
