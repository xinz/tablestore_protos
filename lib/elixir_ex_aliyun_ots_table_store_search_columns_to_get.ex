  ...
  (
      ...
      [
        defp(encode_return_type(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:return_type, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        defp(encode_column_names(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:column_names, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                {[column_names: msg.column_names ++ [delimited]], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          ExAliyunOts.TableStoreSearch.ColumnsToGet,
    ...
    def(defs_by_name()) do
      %{
        ...
        return_type:
          {1, {:scalar, :RETURN_ALL}, {:enum, ExAliyunOts.TableStoreSearch.ColumnReturnType}}
      }
    end
    ...
    def(fields_defs()) do
      [
        %{
          ...
          kind: {:scalar, :RETURN_ALL},
          label: :optional,
          name: :return_type,
          tag: 1,
          type: {:enum, ExAliyunOts.TableStoreSearch.ColumnReturnType}
        },
        %{
          __struct__: Protox.Field,
          json_name: "columnNames",
          kind: :unpacked,
          label: :repeated,
          name: :column_names,
          tag: 2,
