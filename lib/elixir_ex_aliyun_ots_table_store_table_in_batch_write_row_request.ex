  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          {msg, set_fields} =
            parse_key_value([], bytes, struct(ExAliyunOts.TableStore.TableInBatchWriteRowRequest))
            ...
            {2, _, bytes} ->
              ...
              {[:rows | set_fields],
               [
                 rows:
                   msg.rows ++
                     [ExAliyunOts.TableStore.RowInBatchWriteRowRequest.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        ExAliyunOts.TableStore.TableInBatchWriteRowRequest,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:rows, :unpacked, {:message, ExAliyunOts.TableStore.RowInBatchWriteRowRequest}}
      }
    end
    ...
    def defs_by_name() do
      %{
        rows: {2, :unpacked, {:message, ExAliyunOts.TableStore.RowInBatchWriteRowRequest}},
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :rows,
          tag: 2,
          type: {:message, ExAliyunOts.TableStore.RowInBatchWriteRowRequest}
        }
      ]
    end
