    ...
    [
      defp encode_value(acc, msg) do
        try do
          case msg.value do
            nil -> acc
            _ -> [acc, "\t", Protox.Encode.encode_double(msg.value)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(ExAliyunOts.TableStoreSearch.MaxAggregationResult))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        ExAliyunOts.TableStoreSearch.MaxAggregationResult,
