          ...
          def(decode!(bytes)) do
            {msg, set_fields} =
              parse_key_value(
                [],
                bytes,
                struct(ExAliyunOts.TableStore.TableInBatchGetRowResponse)
              )
              ...
              {2, _, bytes} ->
                ...
                {[:rows | set_fields],
                 [
                   rows:
                     msg.rows ++
                       [ExAliyunOts.TableStore.RowInBatchGetRowResponse.decode!(delimited)]
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          ExAliyunOts.TableStore.TableInBatchGetRowResponse,
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :rows,
          tag: 2,
          type: {:message, ExAliyunOts.TableStore.RowInBatchGetRowResponse}
        }
      ]
    end
