  ...
  (
    ...
    (
      (
        ...
        def(encode!(msg)) do
          [] |> encode_field_name(msg) |> encode_points(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(ExAliyunOts.TableStoreSearch.GeoPolygonQuery))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          ExAliyunOts.TableStoreSearch.GeoPolygonQuery,
    ...
    def(defs()) do
      %{1 => {:field_name, {:scalar, ""}, :string}, 2 => {:points, :unpacked, :string}}
    end
    ...
    def(defs_by_name()) do
      %{field_name: {1, {:scalar, ""}, :string}, points: {2, :unpacked, :string}}
    end
