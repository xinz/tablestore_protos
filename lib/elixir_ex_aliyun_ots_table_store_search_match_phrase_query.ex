...
defmodule ExAliyunOts.TableStoreSearch.MatchPhraseQuery do
  @moduledoc false
  defstruct field_name: nil, text: nil
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_field_name(msg) |> encode_text(msg)
      end
    )
    ...
    [
      ...
      defp encode_text(acc, msg) do
        try do
          case msg.text do
            nil -> acc
            _ -> [acc, "\x12", Protox.Encode.encode_string(msg.text)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(ExAliyunOts.TableStoreSearch.MatchPhraseQuery))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        ExAliyunOts.TableStoreSearch.MatchPhraseQuery,
  ...
  (
    ...
    def defs() do
      %{1 => {:field_name, {:scalar, ""}, :string}, 2 => {:text, {:scalar, ""}, :string}}
    end
    ...
    def defs_by_name() do
      %{field_name: {1, {:scalar, ""}, :string}, text: {2, {:scalar, ""}, :string}}
    end
  )
