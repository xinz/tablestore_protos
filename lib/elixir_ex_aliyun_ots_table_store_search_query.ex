...
defmodule ExAliyunOts.TableStoreSearch.Query do
    ...
    [
      ...
      defp encode_query(acc, msg) do
        try do
          case msg.query do
            nil -> acc
            _ -> [acc, "\x12", Protox.Encode.encode_bytes(msg.query)]
          end
        rescue
          ArgumentError ->
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        ExAliyunOts.TableStoreSearch.Query,
  ...
  (
    ...
    def defs() do
      %{
        1 => {:type, {:scalar, :MATCH_QUERY}, {:enum, ExAliyunOts.TableStoreSearch.QueryType}},
        2 => {:query, {:scalar, ""}, :bytes}
      }
    end
    ...
    def defs_by_name() do
      %{
        query: {2, {:scalar, ""}, :bytes},
        type: {1, {:scalar, :MATCH_QUERY}, {:enum, ExAliyunOts.TableStoreSearch.QueryType}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        %{
          ...
          json_name: "type",
          kind: {:scalar, :MATCH_QUERY},
          label: :optional,
          name: :type,
          tag: 1,
          type: {:enum, ExAliyunOts.TableStoreSearch.QueryType}
        },
        %{
          __struct__: Protox.Field,
          json_name: "query",
