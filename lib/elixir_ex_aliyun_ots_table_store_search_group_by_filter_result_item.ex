...
defmodule(ExAliyunOts.TableStoreSearch.GroupByFilterResultItem) do
  ...
  (
    ...
    def(defs_by_name()) do
      %{
        row_count: {1, {:default, 0}, :int64},
        sub_aggs_result:
          {2, {:default, nil}, {:message, ExAliyunOts.TableStoreSearch.AggregationsResult}},
        sub_group_bys_result:
          {3, {:default, nil}, {:message, ExAliyunOts.TableStoreSearch.GroupBysResult}}
      }
    end
