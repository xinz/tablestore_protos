      ...
      defp(encode_row_count(acc, msg)) do
        try do
          case(msg.row_count) do
            ...
            _ ->
              [acc, "\b", Protox.Encode.encode_int64(msg.row_count)]
          end
        rescue
          ArgumentError ->
      ...
      defp(encode_sub_aggs_result(acc, msg)) do
        try do
          case(msg.sub_aggs_result) do
            ...
            _ ->
              [acc, <<18>>, Protox.Encode.encode_message(msg.sub_aggs_result)]
          end
        rescue
          ArgumentError ->
            reraise(
      ...
      defp(encode_sub_group_bys_result(acc, msg)) do
        try do
          case(msg.sub_group_bys_result) do
            ...
            _ ->
              [acc, <<26>>, Protox.Encode.encode_message(msg.sub_group_bys_result)]
          end
        rescue
          ArgumentError ->
            reraise(
