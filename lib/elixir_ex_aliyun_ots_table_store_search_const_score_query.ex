...
defmodule(ExAliyunOts.TableStoreSearch.ConstScoreQuery) do
      ...
      defp(encode_filter(acc, msg)) do
        try do
          case(msg.filter) do
            ...
            _ ->
              [acc, "\n", Protox.Encode.encode_message(msg.filter)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(bytes, struct(ExAliyunOts.TableStoreSearch.ConstScoreQuery))
        end
      )
    )
  ...
  (
    ...
    def(json_decode!(input, opts \\ [])) do
      ...
      Protox.JsonDecode.decode!(
        input,
        ExAliyunOts.TableStoreSearch.ConstScoreQuery,
  ...
  (
    ...
    def(defs()) do
      %{1 => {:filter, {:scalar, nil}, {:message, ExAliyunOts.TableStoreSearch.Query}}}
    end
    ...
    def(defs_by_name()) do
      %{filter: {1, {:scalar, nil}, {:message, ExAliyunOts.TableStoreSearch.Query}}}
    end
  )
