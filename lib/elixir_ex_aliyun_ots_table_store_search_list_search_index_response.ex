          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {1, _, bytes} ->
                ...
                {[
                   indices:
                     msg.indices ++ [ExAliyunOts.TableStoreSearch.IndexInfo.decode!(delimited)]
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          ExAliyunOts.TableStoreSearch.ListSearchIndexResponse,
    ...
    def(fields_defs()) do
      [
        %{
          ...
          name: :indices,
          tag: 1,
          type: {:message, ExAliyunOts.TableStoreSearch.IndexInfo}
        }
      ]
    end
