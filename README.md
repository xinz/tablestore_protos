...
Notice: this step can be ignored in the feture, since run `mix escript.install hex protobuf` will generated for 0.7.1 version, but we would like to use the master branch `src/elixirpb.proto` for define module prefix.
